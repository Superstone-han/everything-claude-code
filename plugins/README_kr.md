...
플러그인은 Claude Code에 새로운 도구와 기능을 추가합니다. 이 가이드는 설치만 다룹니다 - 언제 왜 사용하는지는 [전체 기사](https://x.com/affaanmustafa/status/2012378465664745795)를 참조하세요.
...
**개발:**
- `typescript-lsp` - TypeScript 지능
- `pyright-lsp` - Python 타입 검사
- `hookify` - 대화형으로 hooks 생성
